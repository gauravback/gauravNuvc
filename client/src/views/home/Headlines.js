...
function Headlines() {
  return (
    <div class="alert"  style={{backgroundColor: 'rgb(63, 1, 83)', margin:'0.5vw',display:'flex'}}>
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-exclamation-diamond" viewBox="0 0 16 16">
  ...
  <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"/>
      ...
      <marquee behavior='scroll' direction='left' style={{}}>
          <h5 style={{color: '#ffffff', fontWeight: 'bold'}}> उद्यमित
