...
function EmailVerify() {
  ...
  return (
    <div>
    <Card style={{margin:"auto", backgroundColor:"rgb(252 252 252)",display: "flex", height: "30vh", width: "40vw",borderRadius: "10px",transition: "none",boxShadow:"none"}}>
      <Card.Header>Featured</Card.Header>
      <Card.Body>
        <Card.Title>Email Verification</Card.Title>
        <Card.Text>
          An email has been sent to your Email address.
          PLease use the link in your email to login.
        </Card.Text>
      </Card.Body>
    </Card>
